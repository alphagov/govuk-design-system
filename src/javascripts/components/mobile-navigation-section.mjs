...
class MobileNavigationSection extends Component {
  ...
  constructor($root) {
    ...
    // Initialise whether the section should be expanded or not
    // first so that showing/hidding the mobile navigation
    // based on viewport keeps the section open appropriately
    // if it's the current section
  ...
  /**
   * @returns {HTMLElement} The subnavigation
   */
  createSubNav() {
  ...
  /**
   * Reveals or hides the sub navigation depending
