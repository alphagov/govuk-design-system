...
This guidance is for government teams that build online services. To learn about writing alternative text for website pages on www&period;gov&period;uk using the main GOV.UK publishing platform, [go to GOV.UK’s ‘Images’ guidance](https://www.gov.uk/guidance/content-design/images).
