...
<table class="govuk-table app-table--constrained">
  ...
  <tbody class="govuk-table__body">
    ...
    <tr class="govuk-table__row">
      ...
      <td class="govuk-table__cell">Variable</td>
      <td class="govuk-table__cell">Set the URL for the Open Graph image meta tag. The URL must be absolute, including the protocol and domain name. If you're using the refreshed GOV.UK brand, you may need to updated this path to point to the updated assets.
</td>
    </tr>
    <tr class="govuk-table__row">
