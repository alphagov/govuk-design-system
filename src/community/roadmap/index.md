...
We've release [GOV.UK Frontend v5.11.1](https://github.com/alphagov/govuk-frontend/releases/tag/v5.11.1), which fixes link styles in the Service navigation on inverted backgrounds and makes govuk-shade and govuk-tint more reliable.
