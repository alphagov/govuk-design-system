...
{% set wcagCallout %}
  ...
  - [find content info in a consistent place across 'Service unavailable pages'](/patterns/service-unavailable-pages/#wcag-consistent-content-service-unavailable)
