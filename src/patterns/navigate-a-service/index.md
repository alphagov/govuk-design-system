...
The [Service navigation component includes ‘slots’](/components/service-navigation/#use-slots-to-add-custom-elements) to support adding custom elements. You’ll need to decide on the most appropriate layout and positioning and provide your own styles.
