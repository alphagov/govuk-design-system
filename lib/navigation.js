    ...
    for (const itemPath of itemPaths) {
      ...
      item.items.push(
        new NavigationItem({
          ...
          // RESTART HERE: I think every time we use subnav items
          // we group them, so we could do this in this function instead
          theme: frontmatter.theme,

          // RESTART HERE: Don't think it's navigation related
          // - Double check in the templates
          // - clean up if not related
