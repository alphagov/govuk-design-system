...
const runIfFilesChanged = require('./metalsmith-run-if-files-changed')
...
module.exports = metalsmith
  ...
  .use(
    runIfFilesChanged(rollup('javascripts/application.mjs'), {
      patterns: ['javascripts/**/*.{js,mjs}']
    })
  )
  .use(
    runIfFilesChanged(rollup('javascripts/application-example.mjs'), {
      patterns: ['javascripts/**/*.{js,mjs}']
    })
  )
