...
const inPlaceRunner = require('./in-place-runner.js')
...
module.exports = metalsmith
  ...
  .use(
    inPlaceRunner(
      [
        ['accessibility/**/*.{md,njk}'],
        ['community/**/*.{md,njk}'],
        ['components/index.{md,njk}'],
        ['components/accordion/**/*.{md,njk}'],
        ['components/back-link/**/*.{md,njk}'],
        ['components/breadcrumbs/**/*.{md,njk}'],
        ['components/button/**/*.{md,njk}'],
        ['components/character-count/**/*.{md,njk}'],
        ['components/checkboxes/**/*.{md,njk}'],
        ['components/cookie-banner/**/*.{md,njk}'],
        ['components/date-input/**/*.{md,njk}'],
        ['components/details/**/*.{md,njk}'],
        ['components/error-message/**/*.{md,njk}'],
        ['components/error-summary/**/*.{md,njk}'],
        ['components/exit-this-page/**/*.{md,njk}'],
        ['components/fieldset/**/*.{md,njk}'],
        ['components/file-upload/**/*.{md,njk}'],
        ['components/footer/**/*.{md,njk}'],
        ['components/header/**/*.{md,njk}'],
        ['components/inset-text/**/*.{md,njk}'],
        ['components/notification-banner/**/*.{md,njk}'],
        ['components/pagination/**/*.{md,njk}'],
        ['components/panel/**/*.{md,njk}'],
        ['components/password-input/**/*.{md,njk}'],
        ['components/phase-banner/**/*.{md,njk}'],
        ['components/radios/**/*.{md,njk}'],
        ['components/select/**/*.{md,njk}'],
        ['components/service-navigation/**/*.{md,njk}'],
        ['components/skip-link/**/*.{md,njk}'],
        ['components/summary-list/**/*.{md,njk}'],
        ['components/table/**/*.{md,njk}'],
        ['components/tabs/**/*.{md,njk}'],
        ['components/tag/**/*.{md,njk}'],
        ['components/task-list/**/*.{md,njk}'],
        ['components/text-input/**/*.{md,njk}'],
        ['components/textarea/**/*.{md,njk}'],
        ['components/warning-text/**/*.{md,njk}'],
        ['errors/**/*.{md,njk}'],
        ['get-started/**/*.{md,njk}'],
        ['patterns/**/*.{md,njk}'],
        ['styles/**/*.{md,njk}'],
