...
const tracer = require('metalsmith-tracer').default // debug plugin execution times
...
const watched = require('../tasks/watch')
...
module.exports = metalsmith
  ...
  // detect whether sass/script files changed (for skipping plugins)
  .use(watched.detectChanges())
