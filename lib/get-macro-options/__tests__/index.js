...
const fixtures = {
  'node_modules/govuk-frontend/govuk/components/radios/macro-options.json': [
    {
  ...
  'node_modules/govuk-frontend/govuk/components/input/macro-options.json': [
    {
...
describe('getMacroOptions', () => {
  ...
  it('gets input component when requested input-field', () => {
