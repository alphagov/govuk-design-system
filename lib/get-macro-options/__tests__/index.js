...
const fixtures = {
  'node_modules/govuk-frontend/package/govuk/components/radios/macro-options.json': [
    {
  ...
  'node_modules/govuk-frontend/package/govuk/components/input/macro-options.json': [
    {
