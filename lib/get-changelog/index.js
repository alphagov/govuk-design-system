 ...
 * @returns {Array<ChangelogEntry>} - Changelog entries.
 */
 ...
 *
 * @param {Array<ChangelogEntry>} data - The changelog data.
 */
 ...
 * include a `version`.
 *
 * @param {ChangelogEntry} entry - A singular changelog entry.
 * @returns {ChangelogEntry} - The modified changelog entry.
 */
 ...
 *
 * @param {Array<ChangelogEntry>} changelog - The array of changelog items
 * @returns {Array<ChangelogEntry>} - The sorted array
 */
 ...
 * @returns {Array<ChangelogEntry>} - The truncated array
 */
 ...
 * @property {string} description - Description of the change, supports Markdown
 * @property {string} item - Slug of the item the change affected
 * @property {string} group - Slug of the group the item belongs to
 * @property {string} [version] - Semantic version number
 * @property {string} [releaseUrl] - Link to the GOV.UK Frontend release for that version
 */
